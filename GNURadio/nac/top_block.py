...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = qtgui.Range(0, samp_rate/2, samp_rate/1000, Rb*4, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "Carrier Freq", "counter", float, QtCore.Qt.Horizontal)
        ...
        self.epy_block_0_0_0 = epy_block_0_0_0.blk(fc=fc, samp_rate=samp_rate)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_const_source_x_0_0, 0), (self.epy_block_0_0_0, 1))
        ...
        self.connect((self.epy_block_0_0_0, 0), (self.qtgui_const_sink_x_0, 0))
        self.connect((self.epy_block_0_0_0, 0), (self.qtgui_time_sink_x_0, 0))
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.epy_block_0_0_0.fc = self.fc
