...
class Practica_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_1.set_block_alias("Diferenciador")
        self.qtgui_time_sink_x_0_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Vector de entrada', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0_0.set_block_alias("Entrada")
        self.qtgui_time_sink_x_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
            'Salida del acumulador', #name
            1, #number of inputs
            None # parent
        )
        ...
        self.qtgui_time_sink_x_0.set_block_alias("Acumulador")
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.qtgui_time_sink_x_0_1, 0))
        ...
        self.connect((self.epy_block_2, 0), (self.blocks_throttle2_0_0, 0))
